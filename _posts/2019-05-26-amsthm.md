...
Proof supports enumerated math environments as in the `amsthm` package, including `definition`, `theorem`, `lemma`, `proof`,
and a few more[^fn1]. To declare an environment, simply use this template:
